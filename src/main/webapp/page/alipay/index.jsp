...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=<%=path%>page/alipay/alipay.trade.page.pay.jsp method=post
			target="_blank">
		...
		<form name=traderefundquery
			action=<%=path%>page/alipay/alipay.trade.fastpay.refund.query.jsp method=post
			target="_blank">
