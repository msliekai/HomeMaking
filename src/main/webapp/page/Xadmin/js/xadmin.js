...
layui.use(['layer','element','jquery'],function() {
    ...
    $('.left-nav #nav').on('click', 'li', function(event) {
        ...
        if($(this).children('.sub-tblmenu').length){
            if($(this).hasClass('open')){
                $(this).removeClass('open');
                $(this).find('.nav_right').html('&#xe697;');
                $(this).children('.sub-tblmenu').stop(true,true).slideUp();
                $(this).siblings().children('.sub-tblmenu').slideUp();
            }else{
                $(this).addClass('open');
                $(this).children('a').find('.nav_right').html('&#xe6a6;');
                $(this).children('.sub-tblmenu').stop(true,true).slideDown();
                $(this).siblings().children('.sub-tblmenu').stop(true,true).slideUp();
