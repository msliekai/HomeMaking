...
<head>
    ...
    <title>Pricing - HomeCleaner</title>
...
<!--package-area start-->
<div class="package-area pt-105 pt-sm-65 pb-120 pb-sm-80">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h2>Prices & Plans</h2>
                    <p>If everything looks good, just complete the entire form to book a service with our <br/> online service booking</p>
                </div>
            </div>
        </div>
        <div class="row package-carousel mt-65 mt-sm-55">
            <div class="col-lg-4">
                <div class="package-single style-2">
                    <h4>STANDARD</h4>
                    <h2>$100.00</h2>
                    <h5>/ per month</h5>
                    <ul class="list-none">
